"""
Модуль создания персонажа и тренировки его навыков.
"""
...
class Character:
    ...
    def special(self):
        '''Описывает метод специального умения.'''
...
def main() -> None:
    """Основной модуль. Создание персонажа и тренировка его навыков."""
    run_screensaver()
